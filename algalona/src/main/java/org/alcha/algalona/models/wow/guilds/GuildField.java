...
public class GuildField {
    ...
    public enum Name implements FieldName {
        ...
        /**
         * Gets the {@link GuildField.Name} of the current object and turns it into the "slug"
        ...
        /**
         * Generates a String to be used for displaying the {@link GuildField.Name}. Underscores
     ...
     * requests.
     *
     * @param fieldName {@link GuildField.Name} you want the object to represent
     */
     ...
     *
     * @return {@link GuildField.Name} of the object
     */
    ...
    /**
     * Accepts an Array of {@link GuildField.Name} objects and concatenates their slug values
