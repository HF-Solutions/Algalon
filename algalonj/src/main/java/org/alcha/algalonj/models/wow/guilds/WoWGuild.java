...
import org.alcha.algalonj.models.wow.battlegroups.WoWBattlegroup;
import org.alcha.algalonj.models.wow.battlegroups.WoWEUBattlegroups;
...
public class WoWGuild {
    ...
    public static WoWGuild newInstanceFromJSON(JsonObject jsonObject) {
        ...
        guild.setEmblem(WoWGuildEmblem.fromJSON(jsonObject.getAsJsonObject("emblem")));
