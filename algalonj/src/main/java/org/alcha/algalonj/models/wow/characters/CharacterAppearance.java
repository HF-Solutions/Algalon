 ...
 * <p>Stores the values associated with a {@link java.lang.Character Character's} appearance. All fields
...
public class CharacterAppearance extends CharacterField {
    /** Stores the integer for the face variation of a {@link java.lang.Character} **/
    private int mFaceVariation;

    /** Stores the integer for the skin color of a {@link java.lang.Character} **/
    private int mSkinColor;

    /** Stores the integer for the hair variation of a {@link java.lang.Character} **/
    private int mHairVariation;

    /** Stores the integer for the hair color of a {@link java.lang.Character} **/
    private int mHairColor;

    /** Stores the integer for the feature variation of a {@link java.lang.Character} **/
    private int mFeatureVariation;

    /** Stores the boolean that indicates if a {@link java.lang.Character} has their helmet visible **/
    private boolean mShowHelm;

    /** Stores the boolean that indicates if a {@link java.lang.Character} has their cloak visible **/
    private boolean mShowCloak;

    /** Stores the custom display options for a {@link java.lang.Character} **/
